export const directorConfMail = function (fullName, password, email) {
    ...
    * {
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><strong>Hi ${fullName},</strong></span></p>
    <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">We hope tou doing well!</span></p>
    <p style="font-size: 14px; line-height: 140%;">Your PFE-CIMS has been created and now you can go to pfe-cims.web.app and connect to it with this credentials: </p>
    <p style="font-size: 14px; line-height: 140%;">Email : ${email}</p>
    <p style="font-size: 14px; line-height: 140%;">Password: ${password}</p>
    <p style="font-size: 14px; line-height: 140%;"><br /><span style="font-size: 16px; line-height: 22.4px;">Admin</span><br /><strong>PFE-CIMS </strong><br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p>
      </div>
...
export const forgotPassMail = function (iduser) {
                ...
                <tr>
                    <td class="esd-email-paddings" valign="top">
                        <table class="es-content esd-header-popover" cellspacing="0" cellpadding="0" align="center">
                            <tbody>
                                <tr>
                                    <td class="es-adaptive esd-stripe" esd-custom-block-id="88589" align="center">
                                                                ...
                                                                <tr>
                                                                    <td class="es-m-p20b esd-container-frame" width="270" align="left">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image" style="font-size: 0px;" align="center"><a target="_blank"><img class="adapt-img" src="https://demo.stripocdn.email/content/guids/ee9c5db2-6a85-404b-ad69-e0208a5d74cb/images/42061623174961760.jpg" alt style="display: block;" width="270"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                                        <h1 style="color: #333333; font-size: 20px;">Réinitialisation de votre mot de passe<strong>?</strong></h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p15b" align="center">
                                                                                        <h1 style="color: #333333; font-size: 20px;">Une demande de réinitialisation de votre mot de passe a été effectuée. Si vous n'avez pas fait cette demande, ignorez simplement cet e-mail. Si vous avez fait cette demande, cliquez simplement sur le lien ci-dessous&nbsp;:<br></h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center"><span class="es-button-border"><a href="http://localhost:3000/resetpass/${iduser}" class="es-button" target="_blank">réinitialiser le mot de passe</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
